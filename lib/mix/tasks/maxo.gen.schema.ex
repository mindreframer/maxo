defmodule Mix.Tasks.Maxo.Gen.Schema do
  @shortdoc "Generates an Ecto schema and migration file"

  @moduledoc """
  Generates an Ecto schema and migration.

      $ mix maxo.gen.schema Blog.Post blog_posts title:string views:integer
  ...
  Via CLI:
      ...
      $ mix maxo.gen.schema Blog.Post blog_posts title:string views:integer --context-app marketing
  ...
  the type makes it default to `:string`:
      ...
      $ mix maxo.gen.schema Blog.Post blog_posts title views:integer
  ...
  referenced table:
      ...
      $ mix maxo.gen.schema Blog.Post blog_posts title user_id:references:users
  ...
  type of the underlying array element to be given too:
      ...
      $ mix maxo.gen.schema Blog.Post blog_posts tags:array:string

  Unique columns can be automatically generated by using:

      $ mix maxo.gen.schema Blog.Post blog_posts title:unique unique_int:integer:unique

  Redact columns can be automatically generated by using:

      $ mix maxo.gen.schema Accounts.Superhero superheroes secret_identity:redact password:string:redact

  Ecto.Enum fields can be generated by using:

      $ mix maxo.gen.schema Blog.Post blog_posts title status:enum:unpublished:published:deleted
  ...
  a `--table` option may be provided. For example:
      ...
      $ mix maxo.gen.schema Blog.Post posts --table cms_posts
  ...
  A prefix can be specified with the `--prefix` flags. For example:
      ...
      $ mix maxo.gen.schema Blog.Post posts --prefix blog
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix maxo.gen.schema must be invoked from within your *_web application root directory"
      )
    end
  ...
  def copy_new_files(%Schema{context_app: ctx_app} = schema, paths, binding) do
    ...
    Mix.Maxo.copy_from(paths, "priv/templates/maxo.gen.schema", binding, files)
  ...
  def validate_args!([schema, plural | _] = args, help) do
    cond do
      ...
      String.contains?(plural, ":") or plural != Maxo.Naming.underscore(plural) ->
        help.raise_with_help(
  ...
  def raise_with_help(msg) do
    ...
    mix maxo.gen.schema expects both a module name and
    the plural of the generated resource followed by
    any number of attributes:

        mix maxo.gen.schema Blog.Post blog_posts title:string
    """)
  end
