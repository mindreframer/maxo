defmodule Mix.Tasks.Maxo.Gen.Json do
  ...
  Generates controller, JSON view, and context for a JSON resource.
      ...
      mix maxo.gen.json Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix maxo.gen.json Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix maxo.gen.json Sales User users --web Sales
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix maxo.gen.json must be invoked from within your *_web application root directory"
      )
    end
  ...
  def files_to_be_generated(%Context{schema: schema, context_app: context_app}) do
    ...
    web = Mix.Maxo.web_path(context_app)
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Maxo.copy_from(paths, "priv/templates/maxo.gen.json", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :api scope in #{Mix.Maxo.web_path(ctx_app)}/router.ex:
      ...
      Add the resource to your :api scope in #{Mix.Maxo.web_path(ctx_app)}/router.ex:
