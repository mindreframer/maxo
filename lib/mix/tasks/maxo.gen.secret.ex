defmodule Mix.Tasks.Maxo.Gen.Secret do
  @shortdoc "Generates a secret"

  @moduledoc """
  Generates a secret and prints it to the terminal.

      $ mix maxo.gen.secret [length]

  By default, mix maxo.gen.secret generates a key 64 characters long.
  ...
  defp invalid_args! do
    Mix.raise("mix maxo.gen.secret expects a length as integer or no argument at all")
  end
end
