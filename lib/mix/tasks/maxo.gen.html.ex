defmodule Mix.Tasks.Maxo.Gen.Html do
  ...
  Generates controller, HTML views, and context for an HTML resource.
      ...
      mix maxo.gen.html Accounts User users name:string age:integer
  ...
  with their respective names and types. See `mix maxo.gen.schema`
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix maxo.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix maxo.gen.html Sales User users --web Sales
  ...
  use binary ids for primary keys, see `mix maxo.gen.schema` for more
  information.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise(
        "mix maxo.gen.html must be invoked from within your *_web application root directory"
      )
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.Maxo.copy_from(paths, "priv/templates/maxo.gen.html", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :browser scope in #{Mix.Maxo.web_path(ctx_app)}/router.ex:
      ...
      Add the resource to your browser scope in #{Mix.Maxo.web_path(ctx_app)}/router.ex:
