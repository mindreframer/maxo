defmodule Mix.Maxo do
  ...
  ## Examples
      ...
      iex> Mix.Maxo.inflect("Admin.User")
      [alias: "User",
       human: "User",
       base: "Phoenix",
       web_module: "PhoenixWeb",
      ...
      iex> Mix.Maxo.inflect("Admin.SuperUser")
      [alias: "SuperUser",
       human: "Super user",
       base: "Phoenix",
       web_module: "PhoenixWeb",
  ...
  defp app_base(app) do
    case Application.get_env(app, :namespace, app) do
      ^app -> app |> to_string() |> Maxo.Naming.camelize()
      mod -> mod |> inspect()
    end
  end
    ...
    case Application.get_env(this_otp_app, :generators)[:context_app] do
      ...
      false ->
        ...
        via cli option:
            ...
            mix maxo.gen.[task] --context-app some_app
