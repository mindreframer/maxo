defmodule Maxo.Naming do
  ...
  ## Examples
      ...
      iex> Maxo.Naming.resource_name(MyApp.User)
      "user"

      iex> Maxo.Naming.resource_name(MyApp.UserView, "View")
      "user"
  ...
  ## Examples
      ...
      iex> Maxo.Naming.unsuffix("MyApp.User", "View")
      "MyApp.User"

      iex> Maxo.Naming.unsuffix("MyApp.UserView", "View")
      "MyApp.User"
  ...
  ## Examples
      ...
      iex> Maxo.Naming.underscore("MyApp")
      "my_app"

  In general, `underscore` can be thought of as the reverse of
  `camelize`, however, in some cases formatting may be lost:

      Maxo.Naming.underscore "SAPExample"  #=> "sap_example"
      Maxo.Naming.camelize   "sap_example" #=> "SapExample"
  ...
  ## Examples
      ...
      iex> Maxo.Naming.camelize("my_app")
      "MyApp"

      iex> Maxo.Naming.camelize("my_app", :lower)
      "myApp"
  ...
  ## Examples
      ...
      iex> Maxo.Naming.humanize(:username)
      "Username"
      iex> Maxo.Naming.humanize(:created_at)
      "Created at"
      iex> Maxo.Naming.humanize("user_id")
      "User"
